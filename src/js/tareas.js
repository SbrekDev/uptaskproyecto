...
(function(){
        ...
        modal.innerHTML = `
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    ...
                    <input type="text" name="tarea" id="tarea" placeholder="${tarea.nombre ? 'Editar tarea' : 'Añadir tarea al proyecto actual'}" value="${tarea.nombre ? tarea.nombre : ''}"/> 
                </div>
                <div class="opciones">
    ...
    function mostrarAlerta(mensaje, tipo, referencia){
        ...
        //inserta la laerta antes del legend
    ...
    async function agregarTarea(tarea){
        ...
        try {
            ...
            if(resultado.tipo === 'exito'){
                ...
                // agregar el obj tarea al global de tareas
                const tareaObj={
